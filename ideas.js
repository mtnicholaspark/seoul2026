...
export const ITINERARY_IDEAS = [
  ...
  {
    id: 'jamsil-songpa',
    title: 'Lotte World Day (Jamsil & Songpa)',
    tagline: 'A full theme park day — indoor rides, outdoor rides, then Seokchon Lake once the tower lights up',
    neighborhood: 'Jamsil / Songpa-gu',
    bestFor: 'A weekday, arriving right at open — Line 2 direct to Jamsil, no transfer. Budget the whole day; Lotte World has enough indoor + outdoor rides to easily fill one.',
    stops: [
      { time: 'Early Morning', title: 'Light breakfast near Jamsil Station', type: 'tip', notes: "Grab coffee and a pastry from one of the cafés in the Lotte World Mall/Tower complex before the park opens — not tracked in the app, but easy to find right at the entrance." },
      { time: 'Morning', title: 'Lotte World — Adventure (indoor)', type: 'activity', notes: 'Arrive at open to beat the crowds. The indoor "Adventure" hall is climate-controlled — a good first stop before the outdoor half heats up.' },
      { time: 'Midday', title: 'Lotte World — Magic Island (outdoor)', type: 'activity', notes: 'The outdoor half, styled like a fairytale castle island. Buy tickets via Klook/Trazy/KKday ahead of time for a better rate than the gate.' },
      { time: 'Bonus', title: 'Lotte World Aquarium', type: 'tip', notes: "In the same mall complex — good rainy-day backup or add-on if you want a break from rides, not tracked separately in the app." },
      { time: 'Evening', title: 'Seokchon Lake', type: 'activity', notes: 'Free, open 24hrs. Walk it once Lotte World Tower is lit, sunset onward — a calm wind-down after a full day of rides.' },
  ...
  {
    id: 'everland',
    title: 'Everland Day Trip',
    tagline: "Korea's biggest theme park — rides, the zoo, and gardens for a full day out",
    neighborhood: 'Yongin, Gyeonggi-do (day trip from Gangnam)',
    bestFor: 'Tue-Thu for shorter lines; arrive by park open (9:30-10 AM) and budget the entire day — this is a real theme-park trip, not a half-day stop. Halloween decor starts going up in September but peaks mid-October, after this trip ends, so expect early-season decor only.',
    stops: [
      { time: 'Early Morning', title: 'Light breakfast before the shuttle', type: 'tip', notes: 'Grab coffee and something quick near the shuttle pickup point in Gangnam — not tracked in the app, but any of the cafés along Teheran-ro work.' },
      { time: 'Morning', title: 'Shuttle bus to Everland', type: 'tip', notes: 'The best-value way there — ~50-70 min, ₩3-5k. The Bundang Line + local shuttle option takes longer (90-110 min) but works if the shuttle schedule doesn\'t line up. Already noted on the Everland wishlist entry.' },
      { time: 'Late Morning–Afternoon', title: 'Everland', type: 'activity', notes: 'T Express (one of Korea\'s tallest wooden coasters), Zootopia (pandas Fu Bao\'s family among them), and the Four Seasons Garden are the highlights. Gate ~₩59,000, ~₩39,000 via discount vendors (Klook/Trazy/KKday).' },
      { time: 'Evening', title: 'Shuttle back to Gangnam', type: 'tip', notes: 'Time this before the last shuttle departure — check the schedule at the park. Not tracked in the app.' },
      { time: 'Dinner', title: 'Back in Gangnam — Han Chu or whatever sounds good after a long day', type: 'food', notes: 'Double-fried chicken and beer, casual and forgiving of theme-park-tired feet. Or grab food inside Everland before the shuttle if you\'d rather not cook up a plan post-park.' },
    ],
  },
  {
    id: 'jjimjilbang-gangnam',
    title: 'Gangnam Jjimjilbang Recharge Day',
    tagline: 'Saunas, heat rooms, and a foot massage — all a short walk from the apartment',
    neighborhood: 'Yeoksam-dong, Gangnam-gu',
    bestFor: 'A deliberately unscheduled, low-key day — good for slotting in whenever your legs need a break from walking. JCM Spa Sauna is open 24 hrs, so there\'s no need to rush the morning.',
    stops: [
      { time: 'Breakfast (light)', title: 'Toast & coffee near Yeoksam', type: 'tip', notes: "Isaac Toast or any of the small toast-and-coffee counters around Yeoksam/Gangnam Station — a quick, light bite before a heat-heavy day, no need to book a specific location. Not tracked in the app." },
      { time: 'Midday', title: 'JCM Spa Sauna (Yeoksam)', type: 'activity', notes: 'A real neighborhood jjimjilbang, not a tourist-facing luxury spa — sauna, bathhouse, salt room, yellow clay steam room, and massage chairs on site, a few minutes\' walk from the apartment.' },
      { time: 'Afternoon', title: 'Jeongyeon Foot Massage (Gangnam)', type: 'activity', notes: "28 years of reflexology experience, starting with a warm herbal foot soak — a proper massage stop a short walk from the sauna, without booking a hotel spa." },
      { time: 'Dinner (hearty)', title: 'Han Chu', type: 'food', notes: 'Korean-style double-fried chicken and beer, a Gangnam-gu institution for 20+ years — the reward at the end of a slow day.' },
    ],
  },
  {
    id: 'jjimjilbang-yongsan',
    title: 'Dragon Hill Spa Day (Yongsan)',
    tagline: "Seoul's classic all-in-one jjimjilbang — worth the trip, still not a luxury day-spa",
    neighborhood: 'Yongsan-gu',
    bestFor: 'A full relaxing day when you want the jjimjilbang itself to be the main event — Dragon Hill Spa has enough going on (pools, ice room, mini cinema, even a golf range) to fill several hours without ever feeling like a spa splurge.',
    stops: [
      { time: 'Breakfast (light)', title: "Sonyeo Bangatgan (Yongsan I'Park Mall)", type: 'food', notes: 'Injeolmi croissants from the grain-bakery chain — literally in the same mall complex as Dragon Hill Spa, an easy light bite before heading in.' },
      { time: 'Midday', title: 'Dragon Hill Spa', type: 'activity', notes: "One of Seoul's largest, most famous jjimjilbangs — hot/cold pools, medicinal baths, an ice room, infrared rooms, a mini cinema, even a golf practice range. On-site massage available (women's floor is 3F) if you don't want to go elsewhere. Mid-range pricing, not a luxury day-spa." },
      { time: 'Dinner (hearty)', title: 'Kyochon Pilbang', type: 'food', notes: "Kyochon's flagship chimakase concept store in Itaewon-dong — a short trip from Yongsan, and a fitting, more elevated fried-chicken close to the day than a regular branch." },
    ],
  },
  {
    id: 'busan',
